...
unordered_set<string> findWikiLinks(const string& inp) {
    ...
    while (true) {
        ...
        // Set url_start to the next location of "delim" (starting your search
        // at url_start), using std::search. After doing so, break out of the
        // while loop if there are no occurrences of delim left (use your work
        // from the line above). Estimated length: 2-3 lines
        ...
        // delimeter you found above. Make sure to use std::find! (std::find
        // looks for a single element in a container, e.g. character in a
        // string—std::search looks for a series of elements in a container,
        // like a substring in a string. remember that a string is
        // represented as an array of characters, and is also a container!)
        ...
        // Last exercise of this function! Create a string from the two
        // iterators (url_start and url_end) above using a string constructor.
        // Make sure you start the string AFTER the delimiter you found in task
        // 5! Estimated length: 1 lines
