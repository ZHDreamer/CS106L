...
void print_difference(HashMap<string, int>& lecturer_record, string lecturer1,
                      string lecturer2);
...
int student_main() {
    cout << "This is student main. You can try using HashMap as a client by editing "
            "the code here!"
         << endl;
    ...
    cout << "Find the difference in time between two lecturers! \n"
         << "Please enter two names from this list, separated by a space. Then hit "
            "ENTER\n"
         << endl;
...
void print_difference(HashMap<string, int>& lecturer_record, string lecturer1,
    ...
    if (year1 < year2) {
        cout << lecturer1 << " lectured first and " << year2 - year1
             << " year(s) later, " << lecturer2 << " lectured" << endl;
    } else if (year1 > year2) {
        cout << lecturer2 << " lectured first and " << year1 - year2
             << " year(s) later, " << lecturer1 << " lectured" << endl;
    } else {
        cout << lecturer1 << " and " << lecturer2 << " lectured the same year, "
             << year1 << endl;
    }
}